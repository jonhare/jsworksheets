    ...
    var loadFile = function (file, i) {
      ...
      if (file.type.startsWith("image")) {
          reader.onload = operation(cm, function() {
            var images = $(cm.getWrapperElement().parentNode.parentElement).data("images");
            if (!images) images = {};

            //if (!document.__uploads__) document.__uploads__ = {};
            //document.__uploads__[file.name] = reader.result;
            images[file.name] = reader.result;
            $(cm.getWrapperElement().parentNode.parentElement).data("images", images);

            text[i] = "<img src='#"+file.name+"'/>";
